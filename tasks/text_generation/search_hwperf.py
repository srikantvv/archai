...
from archai.discrete_search.evaluators.hwperfmodel.hwperfmodel_latency import HwPerfModelLatency
...
if __name__ == "__main__":
    ...
    search_objectives.add_objective(
        "onnx_latency",
        HwPerfModelLatency(space, seq_len=1024, n_trials=5, use_past=False),
